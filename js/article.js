...
const articleBySections = [
	{
		text: [
			'La vitamina D es un secosteroide y una prohormona1 liposoluble<sup>2</sup> que puede obtenerse de manera exógena a través de ciertos alimentos como el pescado graso, el huevo y los productos lácteos<sup>3</sup> o suplementos nutricionales y de manera endógena por medio de la exposición a la luz solar ultravioleta, siendo esta última la manera más común.<sup>1,2</sup> A la forma inactiva de este nutriente se le conoce como colecalciferol, la cual requiere de dos hidroxilaciones diferentes para ser activada, una en el hígado para convertirse en calcidiol o 25 hidroxicolecalciferol (25(OH)D o 25(OH)D<sub>3</sub> ) y otra en el riñón para que el calcidol se metabolice en calcitriol o 1-alfa,25-dihidroxicolecalciferol (1,25(OH)2D o 1,25(OH)2D<sub>3</sub>).<sup>2</sup> Precisamente, el parámetro más utilizado para medir la cantidad de vitamina D en el organismo son los niveles de 25(OH)D en la sangre, siendo normales las concentraciones >30 ng/mL y óptimas las concentraciones >40 ng/mL.<sup>4</sup> Las concentraciones inferiores a 20 ng/mL representan una deficiencia nutricional.<sup>1,4</sup>',
		],
		id: 1,
		question:
	...
	{
		title: '<h1 class="title-text">¿Cuáles son sus funciones?</h1>',
		text: [
